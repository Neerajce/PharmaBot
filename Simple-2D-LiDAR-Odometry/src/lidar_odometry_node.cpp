...
class LidarOdometryNode : public rclcpp::Node
{
  public:
    LidarOdometryNode() : Node("lidar_odometry_node")
    {
      ...
      rclcpp::QoS qos_profl(10);

      qos_profl.reliability(rclcpp::ReliabilityPolicy::BestEffort);
      qos_profl.durability(RMW_QOS_POLICY_DURABILITY_VOLATILE);
      ...
      scan_subscriber = this->create_subscription<sensor_msgs::msg::LaserScan>(
        scan_topic_name, qos_profl, std::bind(&LidarOdometryNode::scan_callback, this, std::placeholders::_1)
      );
    }
